...
ISL_ARG_BOOL(struct autosa_options, explore_loop_permute, 0,
             "explore-loop-permute", 0,
             "explore loop permutation in the step of array partitioning")
ISL_ARG_INT(struct autosa_options, loop_permute_order, 0, "loop-permute-order",
            "order", 0, "specify which loop ordering to be explored")
